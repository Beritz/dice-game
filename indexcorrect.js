...
var player1img = "dice" + number1 + ".png";
var player1imglocation = "./images/" + player1img;
var player2img = "dice" + number2 + ".png";
var player2imglocation = "./images/" + player2img;
var player2img = document.querySelector(".img2");

var img1 = document.querySelectorAll("placeholderimg.jpg")[0];
img1.setAttribute("src", player1imglocation);
var img2 = document.querySelectorAll("placeholderimg.jpg")[1];
img2.setAttribute("src", player2imglocation);
